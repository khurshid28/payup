    ...
    return function () {
        ...
        var e = {
            3976: function (e, t) {
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.Event = void 0, t.off = function (e, t) {
                    ...
                    if (u(this[0])) for (var n = this[0].eventRegistry, i = this[0], o = "string" == typeof e ? e.split(" ") : [e.type], l = 0; l < o.length; l++) {
                        ...
                        if (void 0 !== c && "global" === p) {
                            var d, h = {bubbles: !0, cancelable: !0, composed: !0, detail: arguments[1]};
                            if (c.createEvent) {
                                try {
                ...
                var a, r = n(9845), o = (a = n(9380)) && a.__esModule ? a : {default: a}, l = n(7760), s = n(2839),
                    c = n(8711), u = n(7215), f = n(4713);
                ...
                var m, g, y = t.EventHandlers = {
                    keyEvent: function (e, t, n, i, a) {
                        var o = this.inputmask, p = o.opts, d = o.dependencyLib, h = o.maskset, v = this, m = d(v),
                            g = e.key, k = c.caret.call(o, v), b = p.onKeyDown.call(this, e, c.getBuffer.call(o), k, p);
                        ...
                        var r = this.inputmask || this, o = r.opts, f = r.dependencyLib, p = r.maskset, d = r.el,
                            h = f(d), v = e.key;
                        if (!0 === t || e.ctrlKey && e.altKey && !r.ignorable || !(e.ctrlKey || e.metaKey || r.ignorable)) {
                            if (v) {
                                var m, g = t ? {begin: a, end: a} : c.caret.call(r, d);
                            ...
                            for (; ;) switch (e.prev = e.next) {
                                case 0:
                                    n = function (e, n, i, a, o) {
                                        var s = c.caret.call(e, n, void 0, void 0, !0), u = i.substr(0, s.begin),
                        ...
                        var a, o = this, u = o.inputmask._valueGet(!0),
                        ...
                        var t = this.inputmask, n = t.dependencyLib, i = this,
                        ...
                        var t = this.inputmask, n = t.maskset, i = this, a = c.caret.call(t, i),
                ...
                var d = a.default.dependencyLib, h = function () {
                    ...
                    return t = e, (n = [{
                        ...
                        key: "initDateObject", value: function (e, t, n) {
                            var i;
                        ...
                        key: "setValue", value: function (e, t, n, i, a) {
                ...
                function O(e, t, n, a) {
                    ...
                    for (P(n).lastIndex = 0; r = P(n).exec(e);) {
                        if (void 0 === t) if (o = w(r)) l += "(" + o[0] + ")", n.placeholder && "" !== n.placeholder ? (c[s] = n.placeholder[r.index % n.placeholder.length], c[n.placeholder[r.index % n.placeholder.length]] = r[0].charAt(0)) : c[s] = r[0].charAt(0); else switch (r[0]) {
                            case"[":
                                l += "(";
                                break;
                            case"]":
                    ...
                    datetime: {
                        ...
                        postValidation: function (e, t, n, i, a, r, o, s) {
                            ...
                            return g && !isNaN(k.date.getTime()) && (a.prefillYear && (g = function (e, t, n) {
                                if (e.year !== e.rawyear) {
                                    var i = v.toString(), a = e.rawyear.replace(/[^0-9]/g, ""),
                ...
                function u(e, t, n, i, a) {
                    if (n - 1 > -1 && "." !== t.buffer[n - 1] ? (e = t.buffer[n - 1] + e, e = n - 2 > -1 && "." !== t.buffer[n - 2] ? t.buffer[n - 2] + e : "0" + e) : e = "00" + e, a.greedy && parseInt(e) > 255 && c.test("00" + e.charAt(2))) {
                        ...
                        if (r.join("").match(/\./g).length < 4) return {refreshFromBuffer: !0, buffer: r, caret: n + 2}
                    }
                    return c.test(e)
                }
                ...
                a.default.extendAliases({
                    ...
                    ip: {
                        ...
                        definitions: {i: {validator: u}, j: {validator: u}, k: {validator: u}, l: {validator: u}},
                        onUnMask: function (e, t, n) {
                            return e
                        },
                        inputmode: "decimal",
                    ...
                    ssn: {
                        mask: "999-99-9999", postValidation: function (e, t, n, i, a, l, s) {
                ...
                a.default.extendAliases({
                    numeric: {
                            ...
                            if (t = function (e, t, n, i, a) {
                                ...
                                return -1 !== h && (d = [h], -1 !== v && d.push(v)), !1 !== d ? {
                                    ...
                                    insert: [{
                                        ...
                                        fromIsValid: !0
                                    }, {pos: f.call(s, "-", r), c: a.negationSymbol.back, fromIsValid: void 0}],
                                    caret: u + a.negationSymbol.back.length
                                }
                            }
                        ...
                        onBeforeMask: function (e, t) {
                            ...
                            var r = "-" === e.charAt(0) || e.charAt(0) === t.negationSymbol.front, o = e.split(a),
                                l = o[0].replace(/[^\-0-9]/g, ""), s = o.length > 1 ? o[1].replace(/[^0-9]/g, "") : "",
                                c = o.length > 1;
                            e = l + ("" !== s ? a + s : s);
                            var f = 0;
                ...
                function f(e, t, n, i, r) {
                    var c, u = e ? e.inputmask : this, f = u.maskset, d = u.opts, h = u.dependencyLib, v = i.slice(),
                        m = "", g = -1, y = d.skipOptionalPartCharacter;
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0;
                var i = v(n(3976)), a = v(n(7392)), r = v(n(4963)), o = n(9716), l = v(n(9380)), s = n(7760),
                    c = n(157), u = n(2391), f = n(8711), p = n(7215), d = n(4713);
                    ...
                    for (; i = t ? d.exec(e) : p.exec(e);) {
                        ...
                        if (h) b(); else switch (a.charAt(0)) {
                            ...
                            case n.quantifiermarker[0]:
                                var O = new o.default(!1, !1, !0), _ = (a = a.replace(/[{}?]/g, "")).split("|"),
                                    M = _[0].split(","), E = isNaN(M[0]) ? M[0] : parseInt(M[0]),
                                ...
                                if (!0 !== n.noValuePatching) {
                                    if (Object.getOwnPropertyDescriptor) {
                                        ...
                                        f && f.get && f.set ? (i = f.get, a = f.set, Object.defineProperty(t, "value", {
                                            ...
                                            this.textContent = e
                                        }, Object.defineProperty(t, "value", {get: s, set: u, configurable: !0}))
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.caret = function (e, t, n, i, r) {
                    ...
                    if (Array.isArray(t) && (n = l.isRTL ? t[0] : t[1], t = l.isRTL ? t[1] : t[0]), void 0 !== t.begin && (n = l.isRTL ? t.begin : t.end, t = l.isRTL ? t.end : t.begin), "number" == typeof t) {
                        ...
                        if (e.scrollLeft = c > e.scrollWidth ? c : 0, e.inputmask.caretPos = {
                            ...
                            void 0 === e.inputmask.caretHook || e.inputmask.caretHook.call(l, {begin: t, end: n})
                        }
                    }
                }, t.determineLastRequiredPosition = function (e) {
                    var t, n, i = this, a = i.maskset, l = i.dependencyLib, c = s.call(i), u = {},
                        f = a.validPositions[c], p = o.getMaskTemplate.call(i, !0, s.call(i), !0, !0), d = p.length,
                ...
                function h(e, t, n) {
                    var i, r, o = this, l = this.dependencyLib, s = this.maskset, c = this.opts, u = this.el,
                        p = s.maskToken, h = t ? n : 0, v = t ? t.slice() : [0], m = [], g = !1,
                        y = t ? t.join("") : "", k = !1;
                        ...
                        function f(r, l, p) {
                            ...
                            if (h === e && void 0 === r.matches) {
                                ...
                                if (r.isAlternator) return function () {
                                    ...
                                    o.hasAlternator = !0;
                                    var a, v = r, y = [], b = m.slice(), x = l.length,
                ...
                function l(e, t, n, i, a, s) {
                    ...
                    var h, v, m, g, y, k, b, x, w, P, S, O = u.extend(!0, [], d.validPositions),
                        _ = u.extend(!0, {}, d.tests), M = !1, E = !1,
                ...
                function d(e, t, n) {
                    var a, o, l = this, s = this.maskset, c = this.opts, u = this.dependencyLib,
                        f = c.skipOptionalPartCharacter, p = l.isRTL ? n.slice().reverse() : n;
        ...
        return function () {
            ...
            var t, a = (t = n(2394)) && t.__esModule ? t : {default: t};
            e.default = a.default
        }(), i
    }()
}));